...
22 recursos en tres grupos, con tres rutas guiadas que reordenan la lista sin ocultar nada. El estado (recursos abiertos y ruta elegida) se guarda en `localStorage` bajo `jads_recursos_v1`. Todo va embebido en un archivo: sin build, sin dependencias, sin peticiones externas.
